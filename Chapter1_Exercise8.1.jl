...
The factors of 20 are $(@bind a1 NumberField(0:100)), $(@bind a2 NumberField(0:100)), $(@bind a3 NumberField(0:100)), $(@bind a4 NumberField(0:100)), $(@bind a5 NumberField(0:100)) and $(@bind a6 NumberField(0:100))

"""

# ╔═╡ 65390735-493b-48d5-bf47-876fbab0253f
ans_1=[a1,a2,a3,a4,a5,a6];
