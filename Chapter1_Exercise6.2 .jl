...
md""" **a)** 
Ali has 758 books. Round off the number of books to the nearest hundred. 

$(@bind a1 NumberField(0:100))
"""

# ╔═╡ c50bd342-2177-4397-94c9-21685776ca91
md""" **b)** 
There are 3219 pupils in a school. Round off the number of pupils to the nearest hundred.

$(@bind b1 NumberField(0:100))
"""

# ╔═╡ 597b6b36-df29-436d-aae8-c483784726eb
md""" **c)** 
Sally has ₱2465 in her savings account. Round off this amount to the nearest ₱100. 

$(@bind c1 NumberField(0:100))
"""

# ╔═╡ 959a6fb8-ea4b-4034-b36c-d5eaaf56a5ee
md""" **d)** 
The distance by air between two cities is 6328 km. Round off this distance to the nearest 100 km.

$(@bind d1 NumberField(0:100))
"""
...
begin
	results = [eval_a(a1)[2],eval_b(b1)[2],eval_c(c1)[2],eval_d(d1)[2]]
