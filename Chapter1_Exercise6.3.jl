...
md"""
#### 3. The table shows the number of stamps collected by 6 boys. Round off each number to the nearest hundred.
"""
...
|----|----|----|
|Ahmad |705 | $(@bind a1 NumberField(0:100))
|Robert |693 | $(@bind a2 NumberField(0:100))
|Jincai | 1999 | $(@bind a3 NumberField(0:100))
|Ravi | 5846 | $(@bind a4 NumberField(0:100))
|Lionel | 1202 | $(@bind a5 NumberField(0:100))
|Shunde | 2055 | $(@bind a6 NumberField(0:100))
 
"""

# ╔═╡ 6be16b37-ff0e-45ae-8aa4-a0d0bd2de60b
ans1 = (a1,a2,a3,a4,a5,a6);
...
begin
	function eval_a(ans)
		if (700,700,2000,5800,1200,2100) == ans
			return correct(),1
...
# ╔═╡ 4a9e72d4-c59b-4b7b-b8ac-27f0f6a09629
eval_a(ans1)[1]

# ╔═╡ 1fa2729a-f3b3-4bb8-b822-4540210a2626
begin
	results = [eval_a(ans1)[2]]
...
# ╔═╡ 4f4d5a9b-eaf4-47fc-95f6-7776320f64b4
