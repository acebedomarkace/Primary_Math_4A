...
md"""
#### 2. Write the values of the digits in each of the following numbers.
"""
...
begin
	function checker_a1(ans)
		...
		elseif ("","","","","")==ans
			...
			print("🙄 Something went wrong. \nCheck if you gave a complete answer." )
			return 0
		end
	end
end;
