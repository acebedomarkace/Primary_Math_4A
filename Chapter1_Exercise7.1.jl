...
|:---:|:---:|:---:|:---:|:---:
|↓||↓||
|$(@bind c1 NumberField(0:100))|+|$(@bind c2 NumberField(0:100))|=|$(@bind c3 NumberField(0:100))
...
|:---:|:---:|:---:|:---:|:---:
|↓||↓||
|$(@bind d1 NumberField(0:100))|-|$(@bind d2 NumberField(0:100))|=|$(@bind d3 NumberField(0:100))
...
|:---:|:---:|:---:|:---:|:---:
|↓||↓||
|$(@bind e1 NumberField(0:100))|+|$(@bind e2 NumberField(0:100))|=|$(@bind e3 NumberField(0:100))
...
|:---:|:---:|:---:|:---:|:---:
|↓||↓||
|$(@bind f1 NumberField(0:100))|-|$(@bind f2 NumberField(0:100))|=|$(@bind f3 NumberField(0:100))
...
begin
	function eval_a(ans)
		if 300+600 == ans
			return correct(),1
		elseif 0 == ans
			return hint(md"The **number line** is a great tool for solving problems like this."),0
		else
...
begin
	function eval_c(ans)
		if (800,200,1000) == ans
			return correct(),1
		elseif (0,0,0) == ans
			return hint(md"Round off the numbers then perform the addition."),0
		else
			return keep_working(),0
		end
	end
...
begin
	function eval_d(ans)
		if (900,300,600) == ans
			return correct(),1
		elseif (0,0,0) == ans
			return hint(md"Round off the numbers then perform the subtraction."),0
		else
			return keep_working(),0
		end
	end
...
begin
	function eval_g(ans)
		if (1800,400,2200) == ans
			return correct(),1
		elseif (0,0,0) == ans
			return md"""""",0
		elseif (1800,400,0) == ans
