...
md""" **(a)**
13,000 - 4000 = $(@bind a1 html"<input type=text >") 
"""
...
md""" **(b)**
46,000 - 12,000 = $(@bind b1 html"<input type=text >") 
"""
...
md""" **(c)**
32,000 - 8000 = $(@bind c1 html"<input type=text >") 
"""
...
md""" **(d)**
54,000 - 21,000 = $(@bind d1 html"<input type=text >") 
"""
...
md""" **(e)**
40,000 - 16,000 = $(@bind e1 html"<input type=text >") 
"""
