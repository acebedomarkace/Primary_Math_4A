...
md""" **(a)**
4000 + 300 + 7 = $(@bind a1 html"<input type=text >")
"""
...
md""" **(b)**
50,000 + 6000 + 400 = $(@bind b1 html"<input type=text >") .
"""
...
md""" **(c)**
30,000 + 700 + 60 + 8 = $(@bind c1 html"<input type=text >") .
"""
...
md""" **(d)**
10,000 + 1000 + 400 = $(@bind d1 html"<input type=text >") .
"""
...
md""" **(e)**
90,000 + 90 = $(@bind e1 html"<input type=text >") .
"""
