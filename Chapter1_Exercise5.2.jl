...
md"""
#### 2. Round off each amount to the nearest ₱10.
"""

# ╔═╡ 6e971be6-c1ce-46fe-9b0a-4399316ef1a3
md""" **a)** 
109 is $(@bind a1 NumberField(0:100)) when rounded off to the nearest ₱10.
"""

# ╔═╡ c50bd342-2177-4397-94c9-21685776ca91
md""" **b)** 
284 is $(@bind b1 NumberField(0:100)) when rounded off to the nearest ₱10.
"""

# ╔═╡ 597b6b36-df29-436d-aae8-c483784726eb
md""" **c)** 
1258 is $(@bind c1 NumberField(0:100)) when rounded off to the nearest ₱10.
"""

# ╔═╡ 959a6fb8-ea4b-4034-b36c-d5eaaf56a5ee
md""" **d)** 
2043 is $(@bind d1 NumberField(0:100)) when rounded off to the nearest ₱10.
"""
