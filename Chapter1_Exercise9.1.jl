...
# ╔═╡ 31f5b147-9b07-444d-aaec-d9a954aa373d
md""" **(a)**  Is 2 a factor of 35?  

Choose from the drop-down whether 'yes' or 'no' then provide a short explanation to your answer
in the box below.
"""

# ╔═╡ 6e971be6-c1ce-46fe-9b0a-4399316ef1a3
@bind a1 Select(["","Yes","No"])

# ╔═╡ 3ff306e4-866c-40bf-b76b-d384ec052aee
@bind sentence_a TextField((50,3))

# ╔═╡ b5dfa483-3e0f-4dd2-b789-6dc28fcd8ea2
ans_a = [a1, sentence_a];

# ╔═╡ 872e609b-141b-4b12-8508-07ec4ca18811
md""" **(b)**  Is 3 a factor of 45?  
...
@bind b1 Select(["","Yes","No"])

# ╔═╡ 077f45cd-a221-4e59-be97-071e576a65aa
@bind sentence_b TextField((50,3))

# ╔═╡ a6deb286-7f8f-40d4-a690-e442bdb9d077
ans_b = [b1, sentence_b];
...
begin
	function eval_a(ans)
		if ["Yes",false] == [ans[1],isempty(ans[2])]
			return correct(),1
		elseif ["",""] == ans
...
# ╔═╡ 7cf71610-b83f-4b89-8638-f0a9174bca98
eval_a(ans_a)[1]
...
# ╔═╡ ae0904f1-5da9-4747-94a5-a47660c3ba65
eval_b(ans_b)[1]
