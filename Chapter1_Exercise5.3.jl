...
md"""
#### 3. The table shows the number of computers sold by a company in the first six months of the year. Round off each number to the nearest ten.
"""
...
|----|----|----|
|January |438 | $(@bind a1 NumberField(0:100))
|February |272 | $(@bind a2 NumberField(0:100))
|March | 103 | $(@bind a3 NumberField(0:100))
|April | 598 | $(@bind a4 NumberField(0:100))
|May | 346 | $(@bind a5 NumberField(0:100))
|June | 269 | $(@bind a6 NumberField(0:100))
...
begin
	function eval_a(ans)
		if (440,270,100,600,350,270) == ans
			return correct(),1
		else
